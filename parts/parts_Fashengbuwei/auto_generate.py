...
'''
s = []
with open('label_Fashengbuwei_q.txt','r',encoding='utf-8') as infile:
    for line in infile:

        s = line.split('\',\'')

with open('label_Fashengbuwei_q.txt','w',encoding='utf-8') as outfile:
    for line in s:
        outfile.write(line + '\n')



with open('label_Fashengbuwei_q_tag.txt','w',encoding='utf-8') as outfile:
    for line in s:
