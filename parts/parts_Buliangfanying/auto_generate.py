...
'''
s = []
with open('label_Buliangfanying_q.txt','r',encoding='utf-8') as infile:
    for line in infile:

        s = line.split('\',\'')

with open('label_Buliangfanying_q.txt','w',encoding='utf-8') as outfile:
    for line in s:
        outfile.write(line + '\n')



with open('label_Buliangfanying_q_tag.txt','w',encoding='utf-8') as outfile:
    for line in s:
